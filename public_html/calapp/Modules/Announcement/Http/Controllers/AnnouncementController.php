...
class AnnouncementController extends Controller
{
    ...
    /**
     * Display a listing of the announcement for dashboard.
     *
     * @param Request $request [Params for list announcement]
     *
     * @return Response
     */
    public function getAnnouncementsForDashboard(Request $request)
    {
        return $this->announcementRepo->getAnnouncementsForDashboard($request);
    }
}
