...
class ProjectsController extends Controller
{
	...
	{
		return $this->projectRepo->getProjectsForList();
	}
	...
	{
		return $this->projectRepo->getAllProjectCount();
	}
	...
	public function update(UpdateProjectRequest $request, $id)
	{
		// --
		// Check role/permission
		// if (!AdminHelper::can_action(43, 'edited')) {
		//     return response()->json("Access denied", 403);
		// }
	...
	public function destroy(Request $request, $id)
	{
		...
		$this->projectRepo->delete($request, $id);
		return response()->json('success');
	}
	...
	public function getProjectSprintTasks()
	{
		...
		return $this->projectRepo->getProjectSprintTasks();
	}
	...
	{
		return $this->projectRepo->getProjectTaskDefect();
	}
	 ...
	 * @return Response
	 */
	public function getProjectForDashboard(Request $request)
	{
		// --
		// Check role/permission
		...
		return $this->projectRepo->getProjectForDashboard($request);
	}
	 ...
	 * @return Response
	 */
	public function getProjectTaskCountByStatus(Request $request)
	{
		// --
		// Check role/permission
		if (!AdminHelper::can_action(1, 'view')) {
		...
		return $this->projectRepo->getProjectTaskCountByStatus($request);
	}
