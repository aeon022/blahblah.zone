...
<html lang="en">
	<head>
		...
		<!-- Stylesheet -->
		<link rel="shortcut icon" href="{{ asset('/img/favicon/favicon-16x16.png') }}" sizes="16x16"/>
		<link rel="shortcut icon" href="{{ asset('/img/favicon/favicon-32x32.png') }}" sizes="32x32"/>
		<link rel="shortcut icon" href="{{ asset('/img/favicon/favicon-96x96.png') }}" sizes="96x96"/>
		<link type="text/css" rel="stylesheet" href="{{ asset('/css/vendor/installer.css') }}"/>
		@yield('style')
		<script>
			// CSRF token
