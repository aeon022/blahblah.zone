...
use Modules\ProjectComment\Http\Requests\CreateProjectCommentRequest;
...
class ProjectCommentController extends Controller
{
     ...
     *
     * @param CreateProjectCommentRequest $request [create project comment]
     *
     * @return Response
     */
    public function store(CreateProjectCommentRequest $request)
    {
