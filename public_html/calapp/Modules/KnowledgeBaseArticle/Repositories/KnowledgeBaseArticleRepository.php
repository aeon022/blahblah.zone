...
class KnowledgeBaseArticleRepository
{
    ...
    /**
     * Get article list for dashboard.
     *
     * @param Request $request [Request for get article]
     *
     * @return Object
     */
    public function getArticleForDashboard($request)
    {
        $article = KnowledgeBaseArticle::orderBy('created_at', 'DESC');

        if ($request->has('length')) {
            $article = $article->take($request->get('length'));
        }
