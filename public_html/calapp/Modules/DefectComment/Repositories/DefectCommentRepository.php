...
class DefectCommentRepository
{
    ...
    public function create($request)
    {
        ...
        if ($defectComment->save()) {
            // --
            // Send mail
            $this->emailsHelper->sendDefectCommentMail(
                $logginUser,
                $defectComment
            );
            // --
            ...
            if (!empty($defect)) {
                ...
                $defectHistory->updated_by_id = Auth::user()->id;
                $defectHistory->description = "Defect information commented : " .
                '<b>'.$defect->defect_name.'</b>';
