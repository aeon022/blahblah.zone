...
Route::group(
    ...
    function () {
        Route::post(
            'mailbox/unread-emails',
            'MailboxController@getUnReadMailByUser'
        );
        ...
        Route::post(
            'mailbox/files/upload',
            'MailboxController@uploadAttachementFiles'
        );
        Route::post(
            'mailbox/attachment/remove',
            'MailboxController@removeAttachementFile'
        );
